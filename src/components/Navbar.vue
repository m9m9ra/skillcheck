  ...
  <div class="navmenu">
    <div class="navbar">
      ...
      <div class="burger"
           ...
           @click="toggleMenu">
        <div/>
        <div style="background-color: rgba(0, 160, 227, 1);"/>
        <div/>
      </div>

      <svg v-else @click="toggleMenu" style="cursor: pointer" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
